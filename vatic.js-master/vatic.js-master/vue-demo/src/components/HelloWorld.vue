...
<template>
    ...
    <ul>
      ...
      <li>
        ...
        <p>载入XML 标注文件: 
            <span id="xmlFile_t" class="btn btn-primary fileinput-button disabled">
                <span>XML</span>
      ...
      <li>
        ...
        <br>
        <p><input class="btn btn-primary" type="button" id="play" value="播放" disabled="true" /><input class="btn btn-primary" type="button" id="pause" value="暂停" disabled="true" style="display: none;" /></p>
        <br>
        <div id="slider"></div>
        <br>
        <div class="bs-example">
          <!-- <div class="row">
            <div class="col-xs-5"> -->
                <input type="text"  class="form-control" id="speed" value="1.00" size="4" aria-describedby="basic-addon3"/>
            <!-- </div>
          </div>  -->
        </div>
    ...
    <script type="text/javascript">
      ...
      function addAnnotatedObjectControls(annotatedObject) {
        ...
        //     <p><input type="checkbox" name="move2" value="异常行为2" /> 异常行为2</p>
        //     <p><input type="checkbox" name="move2" value="异常行为3" /> 异常行为3</p>
        //     <p><input type="checkbox" name="move2" value="异常行为4" /> 异常行为4</p>
        //     <p><input type="checkbox" name="move2" value="异常行为5" /> 异常行为5</p>
        //     <p><input type="checkbox" name="move2" value="异常行为6" /> 异常行为6</p>
        //     <p><input type="checkbox" name="move2" value="异常行为7" /> 异常行为7</p>
        //     <p><input type="checkbox" name="move2" value="异常行为8" /> 异常行为8</p>
        //     <p><input type="checkbox" name="move2" value="异常行为9" /> 异常行为9</p>
        //     <p><input type="checkbox" name="move2" value="异常行为10" /> 异常行为10</p>
        //     <p><input type="checkbox" name="move2" value="异常行为11" /> 异常行为11</p>
        //     <p><input type="checkbox" name="move2" value="异常行为12" /> 异常行为12</p>   
        // </form>
        div.append(del);
